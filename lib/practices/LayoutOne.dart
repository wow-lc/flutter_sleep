...
class LayoutFirst extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 单个按钮组件
    Column _buildButtomColumn(IconData icon, String label) {
    ...
    Widget buttonSection = new Container(
        child: new Row(
            ...
            children: [
          _buildButtomColumn(Icons.call, "call"),
          _buildButtomColumn(Icons.near_me, "Route"),
          _buildButtomColumn(Icons.share, "share"),
        ]));
